# Generated by Django 3.2.7 on 2022-01-15 08:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+640226466446', max_length=30, region=None, verbose_name='Phone Number')),
                ...
                ('gender', models.CharField(choices=[('Make', 'Male'), ('Female', 'Female'), ('Other', 'Other')], default='Other', max_length=20, verbose_name='Gender')),
                ...
                ('is_buyer', models.BooleanField(default=False, help_text='Are you looking to buy a home', verbose_name='Buyer')),
                ('is_seller', models.BooleanField(default=False, help_text='Are you looking to sell a home?', verbose_name='Seller')),
