...
from real_estate_project.settings.base import AUTH_USER_MODEL
...
class Rating(TimeStampedUUIDModel):
    ...
    agent = models.ForeignKey(Profile, verbose_name=_(
        "Agent being rated"), related_name="agent_review", on_delete=models.SET_NULL, null=True)
